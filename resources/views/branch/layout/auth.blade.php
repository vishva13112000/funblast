...
<!-- 
                            <li>
                                <a href="{{route('admin.shopcategory.index')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                    <span class="pcoded-mtext"
                                          data-i18n="nav.form-components.main">Manage Shop Category</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li> -->
                            <!-- <li>
                                ...
                                <a href="{{route('admin.country.index')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                    <span class="pcoded-mtext"
                                          data-i18n="nav.form-components.main">Manage Country</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li> -->
                               ...
                               <!-- <li>
                                ...
                                <a href="{{route('admin.product.index')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                    <span class="pcoded-mtext"
                                          data-i18n="nav.form-components.main">Manage Product</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                        -->
                            <!-- <li>
                                <a href="{{route('admin.shops.index')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                    <span class="pcoded-mtext"
                                          data-i18n="nav.form-components.main">Manage Shop</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li> -->
                            <!-- <li>
                                <a href="{{route('admin.category.index')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                    <span class="pcoded-mtext"
                                          data-i18n="nav.form-components.main">Manage Category</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li> -->

                            <li>
                                <a href="{{route('branch.customer.index')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                    <span class="pcoded-mtext"
                            ...
                            <li>
                                <a href="{{route('branch.payment.index')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                    <span class="pcoded-mtext"
                                    data-i18n="nav.form-components.main">Payment History</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                            ...
                            <!--  <li>
                                <a href="{{route('admin.payment.index')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                    <span class="pcoded-mtext"
                                          data-i18n="nav.form-components.main">Payment Master</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li> -->
                            <!--   <li>
                                <a href="{{route('admin.ticket.index')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                    <span class="pcoded-mtext"
                                          data-i18n="nav.form-components.main">Ticket Master</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li> -->
