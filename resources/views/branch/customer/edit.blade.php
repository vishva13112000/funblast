            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('branch.customer.edit',$customer->id)}}">Edit
                                Customer</a>
                        </li>
                    </ul>
                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-4">
                                             ...
                                             <div class="form-group col-4">
                                                ...
                                                <input type="text" class="form-control" id="mobileno" name="mobileno"value="{{$customer->mobileno}}">
                                        ...
                                        <!--       <div class="form-group col-4">
                                                ...
                                                <select class="form-control selectbranch" name="branch_id">
                                                    ...
                                                    <option value="{{$branch->id}}"
                                                        @if($branch->id == $customer->branch_id) selected @endif>{{$branch->name}}</option>
                                                        @endforeach
                                                </select>
                                            </div> -->
        ...
        $(document).ready(function () {
            ...
            $(".submit").click(function (event) {
                ...
                if ($(".customerFrm").valid()) {
                    $.ajax({
                        type: "POST",
                        url: "{{route('branch.customer.update')}}",
