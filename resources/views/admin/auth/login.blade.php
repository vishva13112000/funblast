    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <form class="md-float-material form-material" method="POST" action="{{ url('/admin/login') }}">
                    {{ csrf_field() }}
                             ...
                             <div class="row m-t-25 text-left">
                                <div class="col-12">
                                    ...
                                    <div class="forgot-phone text-right f-right">
                                        <a href="{{ url('admin/password/reset') }}"  class="text-right f-w-600"> Forgot Password?</a>
                                  </div>
                                </div>  
                            </div>
