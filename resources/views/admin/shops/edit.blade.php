            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.shops.edit',$shop->id)}}">Edit Shop</a>
                        </li>
                    </ul>
                </div>
            </div>
                                    ...
                                    <form class="shopFrm">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-4">
                                                ...
                                                <select class="form-control shopselect" name="shopcategory_id">
                                                    ...
                                                    @foreach($shopcategories as $shopcategory)
                                                        <option
                                                            value="{{$shopcategory->id}}" @if($shopcategory->id == $shop->shopcategory_id) selected @endif>{{$shopcategory->title}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group col-4">
                                            ...
                                            <div class="form-group col-4">
                                                ...
                                                <input type="number" class="form-control" id="phoneno" name="phoneno"  value="{{$shop->phoneno}}">
                                            </div>

                                            <div class="form-group col-4">
                                                <label for="title">Address </label>
                                                <textarea class="form-control" name="address"> {{$shop->address}}</textarea>
                                            </div>
                                            <div class="form-group col-4">
                                            ...
                                            <div class="form-group col-4">
                                                ...
                                                <select class="form-control shopselect state_id" name="state_id">
                                                    ...
                                                    @foreach($states as $state)
                                                        <option value="{{$state->id}}" @if($state->id == $shop->state_id) selected @endif>{{$state->name}}</option>
                                                    @endforeach
            ...
            $(document).on('change','.country_id',function (){
                $.ajax({
                    ...
                    success: function (data) {
                        // console.log(data);
                        $(".state_id").html("");
                        $(".city_id").html("<option>Select CityF$(D</option>");
