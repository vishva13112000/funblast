            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.brand.edit',$brand->id)}}">Edit Brand</a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="card-block">
                                    ...
                                    <form class="brandFrm">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-4">
                                                <label for="title">Brand Image </label>
                                                <input type="file" class="form-control" id="image" name="image" accept="image/*">
                                            </div>
                                            <div class="form-group col-12">

                                                <img src="{{url($brand->image)}}" height="100px;" width="200px;">
                                            </div>
                        ...
                        success: function (data) {
                            if (data.status === 'success') {
                                swal({
                                    ...
                                    window.location = "{{route('admin.brand.index')}}"
                                });
